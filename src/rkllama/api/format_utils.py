...
def format_rerank_input(query: str, document: str, instruction: str = '') -> str:
    """
    Format the input for rerank model inference.

    Args:
        query (str): The query text to match against
        document (str): The document/passage to be ranked
        instruction (str): Optional instruction prefix for the model

    Returns:
        str: Formatted input text for rerank model
    """
    if not instruction:
